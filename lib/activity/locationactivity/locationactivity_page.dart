...
class LocationActivityPage extends StatefulWidget {
  final Map<String, dynamic>? activityData;
  const LocationActivityPage({super.key, this.activityData});

  @override
  State<LocationActivityPage> createState() => _LocationActivityPageState();
}

class _LocationActivityPageState extends State<LocationActivityPage> {
